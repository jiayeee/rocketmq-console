...
public class ConsumerService extends AbstractService {
    ...
    public Table consumerProgress(String consumerGroup) throws Throwable {
        ...
        try {
            ...
            if (isNotBlank(consumerGroup)) {
                ...
                // "#Diff" //
                // );
                String[] thead = new String[] { "#Topic", "#Broker Name", "#QID", "#Broker Offset", "#Consumer Offset", "#Diff" };
                long diffTotal = 0L;
                ...
                String[] thead = new String[] { "#Group", "#Count", "#Version", "#Type", "#Model", "#TPS", "#Diff Total" };
                ...
                for (String topic : topicList.getTopicList()) {
                    if (topic.startsWith(MixAll.RETRY_GROUP_TOPIC_PREFIX)) {
                        ...
                        try {
                            ...
                            logger.warn("examineConsumeStats or examineConsumerConnectionInfo exception, " + tconsumerGroup, e);
                        }
    ...
    public boolean updateSubGroup(String brokerAddr, String clusterName, String groupName, String consumeEnable, String consumeFromMinEnable, String consumeBroadcastEnable, String retryQueueNums,
                                  String retryMaxTimes, String brokerId, String whichBrokerWhenConsumeSlowly) throws Throwable {
        Throwable t = null;
        DefaultMQAdminExt defaultMQAdminExt = getDefaultMQAdminExt();
        ...
        try {
            ...
            if (isNotBlank(whichBrokerWhenConsumeSlowly)) {
                subscriptionGroupConfig.setWhichBrokerWhenConsumeSlowly(Long.parseLong(whichBrokerWhenConsumeSlowly.trim()));
            }
