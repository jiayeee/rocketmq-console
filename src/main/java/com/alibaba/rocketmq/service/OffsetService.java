...
public class OffsetService extends AbstractService {
    ...
    public Table resetOffsetByTime(String consumerGroup, String topic, String timeStampStr, String forceStr) throws Throwable {
        Throwable t = null;
        ...
        try {
            ...
            // "#rollbackOffset" //
            // );
            String[] thead = new String[] { "#brokerName", "#queueId", "#brokerOffset", "#consumerOffset", "#timestampOffset", "#rollbackOffset" };
