...
public class ConsumerAction extends AbstractAction {
    ...
    public String consumerProgress(ModelMap map, HttpServletRequest request, @RequestParam(required = false) String groupName) {
    ...
    public String deleteSubGroup(ModelMap map, HttpServletRequest request, @RequestParam(required = false) String groupName, @RequestParam(required = false) String brokerAddr,
    ...
    public String updateSubGroup(ModelMap map, HttpServletRequest request, @RequestParam(required = false) String brokerAddr, @RequestParam(required = false) String clusterName,
                                 @RequestParam(required = false) String groupName, @RequestParam(required = false) String consumeEnable, @RequestParam(required = false) String consumeFromMinEnable,
                                 @RequestParam(required = false) String consumeBroadcastEnable, @RequestParam(required = false) String retryQueueNums,
        ...
        try {
            if (request.getMethod().equals(GET)) {
                ...
                checkOptions(options);
                consumerService.updateSubGroup(brokerAddr, clusterName, groupName, consumeEnable, consumeFromMinEnable, consumeBroadcastEnable, retryQueueNums, retryMaxTimes, brokerId,
