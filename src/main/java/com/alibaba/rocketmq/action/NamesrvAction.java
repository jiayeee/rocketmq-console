...
public class NamesrvAction extends AbstractAction {
    ...
    public String updateKvConfig(ModelMap map, HttpServletRequest request, @RequestParam(required = false) String namespace, @RequestParam(required = false) String key,
    ...
    public String deleteKvConfig(ModelMap map, HttpServletRequest request, @RequestParam(required = false) String namespace, @RequestParam(required = false) String key) {
    ...
    public String getProjectGroup(ModelMap map, HttpServletRequest request, @RequestParam(required = false) String ip, @RequestParam(required = false) String project) {
    ...
    public String updateProjectGroup(ModelMap map, HttpServletRequest request, @RequestParam(required = false) String ip, @RequestParam(required = false) String project) {
        Collection<Option> options = namesrvService.getOptionsForGetProjectGroup();
    ...
    public String deleteProjectGroup(ModelMap map, HttpServletRequest request, @RequestParam(required = false) String ip, @RequestParam(required = false) String project) {
    ...
    public String wipeWritePerm(ModelMap map, HttpServletRequest request, @RequestParam(required = false) String brokerName) {
