...
public class ConnectionAction extends AbstractAction {
    ...
    public String consumerConnection(ModelMap map, HttpServletRequest request, @RequestParam(required = false) String consumerGroup) {
    ...
    public String producerConnection(ModelMap map, HttpServletRequest request, @RequestParam(required = false) String producerGroup, @RequestParam(required = false) String topic) {
