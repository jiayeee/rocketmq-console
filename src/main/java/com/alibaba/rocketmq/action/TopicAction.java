...
public class TopicAction extends AbstractAction {
    ...
    public String delete(ModelMap map, HttpServletRequest request, @RequestParam(required = false) String clusterName, @RequestParam String topic) {
    ...
    public String update(ModelMap map, HttpServletRequest request, @RequestParam String topic, @RequestParam(required = false) String readQueueNums,
                         @RequestParam(required = false) String writeQueueNums, @RequestParam(required = false) String perm, @RequestParam(required = false) String brokerAddr,
