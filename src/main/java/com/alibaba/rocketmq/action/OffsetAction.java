...
public class OffsetAction extends AbstractAction {
    ...
    public String resetOffsetByTime(ModelMap map, HttpServletRequest request, @RequestParam(required = false) String group, @RequestParam(required = false) String topic,
