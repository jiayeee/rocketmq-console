...
public class BrokerAction extends AbstractAction {
    ...
    public String brokerStats(ModelMap map, HttpServletRequest request, @RequestParam(required = false) String brokerAddr) {
    ...
    public String updateBrokerConfig(ModelMap map, HttpServletRequest request, @RequestParam(required = false) String brokerAddr, @RequestParam(required = false) String clusterName,
